    ...
    <div class="row">
      <div class="col s12 l16">
        <h2 class="indigo-text text-darken-4"> 
          <?php echo "Welcome ", $_SESSION["fname"] ,"!! ^_^";?> </h2>
      </div>
       </div>  
   </section>  
   <div class="tab">
...
<div id="Bookings" class="tabcontent">
  ...
  <div style = "align: center;">
    <table style = "border:2; width=1300;" class="highlight">
      <tr>
...
if(isset($_POST['edit']))
{
  $_SESSION["ed"]=$_POST['edit'];
   
  echo  "<script> alert('".$_SESSION["ed"]."!!'); </script>"; 
...
{   $r0=$row[0];
 ...
 while($row1=mysqli_fetch_array($run1))
 {
    ...
    echo "<tr align='center'>
        ...
        <td><a href=\"#?edit=$row[0]\"><i onclick=\"document.getElementById('id01').style.display='block'\" class=\"material-icons green-text\">mode_edit</i></a></td>
...
?>
          ...
          <div class="input-field">
            ...
            <div class='input-group date' id='datetimepicker1'>
              <input type='text' class="form-control" name="dotravel" required value="<?php echo $_SESSION["u4"];?>"/>
          ...
          <center> <input type="submit" value="UPDATE" class="btn" name="update"></center>
           ...
           <?php  
               ...
               if(isset($_POST['update']))
              {
                  ...
                  $dateTime=  explode(" ", $v5 );
                   if( mysqli_query($con,"update booking set package='$v1',dotravel='$dateTime[0]', timer='$dateTime[1]',mode='$v6', service='$v7' where id=$v0"))
                 {
                       $_SESSION["est"]=$_SESSION["fare"]+((18/100)*$_SESSION["fare"]);
                ...
                exit();
                 ...
                 {
                   echo "<script>
             alert(\"Booking update failed-- ERROR: " . mysqli_error($con)."\");
